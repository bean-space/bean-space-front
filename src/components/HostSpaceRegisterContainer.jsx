...
import { createSpace } from "../api/host";
import { useNavigate } from "react-router-dom";

const HostSpaceRegisterContainer = () => {
  ...
  const handleConfirmSubmit = async () => {
    try {
      ...
      const spaceData = {
        ...space,
        price: parseInt(space.price.replace(/,/g, "")),
        pricePerPerson: parseInt(space.pricePerPerson.replace(/,/g, "")),
...
export default HostSpaceRegisterContainer;
